...
... Elastic Principal Graph - Optimize branching, prune, extend leaves                                              
''',flush=True)
...
def main():
    ...
    parser.add_argument("-epg_max_steps",dest="epg_max_steps", type=int, default=50, help="")
    ...
    parser.add_argument("-epg_ext_mode",dest="epg_ext_mode",  default=None, help="")
    parser.add_argument("-epg_ext_par",dest="epg_ext_par", type=float, default=0.5, help="")
